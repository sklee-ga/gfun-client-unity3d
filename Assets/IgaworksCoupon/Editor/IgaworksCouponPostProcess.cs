...
using UnityEditor.IgaworksCouponEditor;
using UnityEditor.XCodeEditor;

namespace UnityEditor.IgaworksCouponEditor
{
	public static class XCodePostProcess
	{
		...
		public static void OnPostProcessBuild(BuildTarget target, string path)
		{
			...
			if (target == BuildTarget.iOS)
			{
				...
				string projModPath = System.IO.Path.Combine(Application.dataPath, "IgaworksCoupon/Editor/iOS");
