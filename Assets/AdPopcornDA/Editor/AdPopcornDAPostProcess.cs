...
using UnityEditor.AdPopcornDAEditor;
using UnityEditor.XCodeEditor;

namespace UnityEditor.AdPopcornDAEditor
{
	public static class XCodePostProcess
	{
		...
		public static void OnPostProcessBuild(BuildTarget target, string path)
		{
			...
			if (target == BuildTarget.iOS)
			{
				...
				string projModPath = System.IO.Path.Combine(Application.dataPath, "AdPopcornDA/Editor/iOS");
