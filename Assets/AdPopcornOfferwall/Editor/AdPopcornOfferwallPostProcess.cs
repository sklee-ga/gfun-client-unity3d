...
using UnityEditor.AdPopcornOfferwallEditor;
using UnityEditor.XCodeEditor;

namespace UnityEditor.AdPopcornOfferwallEditor
{
	public static class XCodePostProcess
	{
		...
		public static void OnPostProcessBuild(BuildTarget target, string path)
		{
			...
			if (target == BuildTarget.iOS)
			{
				...
				string projModPath = System.IO.Path.Combine(Application.dataPath, "AdPopcornOfferwall/Editor/iOS");
