...
using UnityEditor.IgaworksNanooEditor;
using UnityEditor.XCodeEditor;

namespace UnityEditor.IgaworksNanooEditor
{
	public static class XCodePostProcess
	{
		...
		public static void OnPostProcessBuild(BuildTarget target, string path)
		{
			...
			if (target == BuildTarget.iOS)
			{
				...
				string projModPath = System.IO.Path.Combine(Application.dataPath, "IgaworksNanoo/Editor/iOS");
